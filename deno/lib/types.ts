...
export class StrictZodString extends ZodString<string, string> {
  ...
  static create(params?: RawCreateParams & { coerce?: true }): StrictZodString {
    return new StrictZodString({
      checks: [],
      typeName: ZodFirstPartyTypeKind.ZodString,
      coerce: params?.coerce ?? false,
      ...processCreateParams(params),
...
const strictStringType: typeof StrictZodString.create = (...args) =>
...
export {
  ...
  strictNumberType as number, strictZodObjectType as object, oboolean,
  onumber,
  ...
  recordType as record, setType as set, strictObjectType as strictObject, strictStringType as string, symbolType as symbol,
  effectsType as transformer,
  tupleType as tuple,
  undefinedType as undefined, strictUnionType as union, unknownType as unknown,
  voidType as void, arrayType as wArray, booleanType as wBoolean, numberType as wNumber, objectType as wObject,
  // overriden originals
  stringType as wString, unionType as wUnion
};
